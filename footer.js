          ...
          <a href="index.html" class="flex items-center gap-2">
            <svg width="32" height="32" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
              <defs>
                ...
                <linearGradient id="metalGradFooter" x1="0%" y1="0%" x2="0%" y2="100%">
                  <stop offset="0%" stop-color="#475569" />
                  <stop offset="100%" stop-color="#1e293b" />
                </linearGradient>
              </defs>
              <polygon points="50,90 15,70 15,30 50,10 85,30 85,70" fill="url(#metalGradFooter)" />
              <polygon points="50,85 20,67 20,33 50,15 80,33 80,67" fill="#0f172a" />
              <path d="M 50,20 L 70,55 L 50,50 L 30,55 Z" fill="url(#logoGradFooter)" />
              <path d="M 50,80 C 40,65 60,65 50,80 Z" fill="url(#logoGradFooter)" />
